...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tabbedPane1.addTab("Links", panel21);
        ...
        panel27.add(m_deleteButton);
        final JPanel panel28 = new JPanel();
        panel28.setLayout(new BorderLayout(0, 0));
        panel22.add(panel28, BorderLayout.CENTER);
        final JScrollPane scrollPane8 = new JScrollPane();
        panel28.add(scrollPane8, BorderLayout.CENTER);
        ...
        tabbedPane1.addTab("Modifications", panel29);
        final JPanel panel30 = new JPanel();
        panel30.setLayout(new BorderLayout(0, 0));
        panel29.add(panel30, BorderLayout.CENTER);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel41.add(spacer4, gbc);
        final JPanel panel42 = new JPanel();
        panel42.setLayout(new GridBagLayout());
        panel42.setMinimumSize(new Dimension(56, 33));
        panel42.setPreferredSize(new Dimension(505, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        panel46.add(m_autowireCheckBox);
        final JPanel panel47 = new JPanel();
        panel47.setLayout(new GridBagLayout());
        panel47.setMinimumSize(new Dimension(56, 33));
        panel47.setPreferredSize(new Dimension(505, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        ...
        panel57.add(m_imageFileNameLabel, BorderLayout.CENTER);
        m_backgroundCheckBox = new JCheckBox();
        m_backgroundCheckBox.setText("Background");
        panel57.add(m_backgroundCheckBox, BorderLayout.NORTH);
        m_imageView = new JXImageView();
        panel56.add(m_imageView, BorderLayout.CENTER);
        final JPanel panel58 = new JPanel();
        panel58.setLayout(new BorderLayout(0, 0));
        panel53.add(panel58, BorderLayout.NORTH);
        ...
        panel61.add(m_soundFileNameLabel, BorderLayout.CENTER);
        final JPanel panel62 = new JPanel();
        panel62.setLayout(new BorderLayout(0, 0));
        panel1.add(panel62, BorderLayout.NORTH);
        final JToolBar toolBar1 = new JToolBar();
        toolBar1.setBorderPainted(false);
        toolBar1.setFloatable(false);
        panel62.add(toolBar1, BorderLayout.CENTER);
        ...
        panel62.add(m_languageComboBox, BorderLayout.EAST);
