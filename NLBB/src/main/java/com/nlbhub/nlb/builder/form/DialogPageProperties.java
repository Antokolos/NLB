...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tabbedPane1.addTab("Links", panel23);
        ...
        panel24.add(panel25, BorderLayout.EAST);
        ...
        panel29.add(m_deleteButton);
        final JPanel panel30 = new JPanel();
        panel30.setLayout(new BorderLayout(0, 0));
        panel24.add(panel30, BorderLayout.CENTER);
        final JScrollPane scrollPane10 = new JScrollPane();
        panel30.add(scrollPane10, BorderLayout.CENTER);
        ...
        scrollPane10.setViewportView(m_linksTable);
        final JPanel panel31 = new JPanel();
        panel31.setLayout(new BorderLayout(0, 0));
        tabbedPane1.addTab("Modifications", panel31);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel37.add(scrollPane11, gbc);
        m_returnPageIdTextField = new JTextField();
        m_returnPageIdTextField.setColumns(42);
        scrollPane11.setViewportView(m_returnPageIdTextField);
        ...
        scrollPane12.setViewportView(m_moduleNameTextField);
        ...
        scrollPane13.setViewportView(m_moduleConstraintTextField);
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel43.add(spacer4, gbc);
        final JPanel panel44 = new JPanel();
        panel44.setLayout(new GridBagLayout());
        panel44.setMinimumSize(new Dimension(56, 33));
        panel44.setPreferredSize(new Dimension(505, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 1;
        gbc.weightx = 1.0;
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel44.add(scrollPane14, gbc);
        m_autowireInConstraintTextField = new JTextField();
        m_autowireInConstraintTextField.setColumns(42);
        scrollPane14.setViewportView(m_autowireInConstraintTextField);
        final JLabel label9 = new JLabel();
        label9.setHorizontalTextPosition(11);
        label9.setText("Autowire in constraint");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.EAST;
        panel43.add(label9, gbc);
        ...
        panel48.add(m_autowireCheckBox);
        m_globalAutowireCheckBox = new JCheckBox();
        m_globalAutowireCheckBox.setText("Global Autowire");
        panel48.add(m_globalAutowireCheckBox);
        final JPanel panel49 = new JPanel();
        panel49.setLayout(new GridBagLayout());
        panel49.setMinimumSize(new Dimension(56, 33));
        panel49.setPreferredSize(new Dimension(505, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        ...
        panel54.setMinimumSize(new Dimension(10, 250));
        panel53.add(panel54, BorderLayout.CENTER);
        panel54.setBorder(BorderFactory.createTitledBorder("Page text"));
        ...
        panel65.add(m_soundFileNameLabel, BorderLayout.CENTER);
        m_soundSFXCheckBox = new JCheckBox();
        m_soundSFXCheckBox.setText("SFX");
        panel65.add(m_soundSFXCheckBox, BorderLayout.NORTH);
        final JPanel panel66 = new JPanel();
        panel66.setLayout(new BorderLayout(0, 0));
        panel1.add(panel66, BorderLayout.NORTH);
        final JToolBar toolBar1 = new JToolBar();
        toolBar1.setBorderPainted(false);
        toolBar1.setFloatable(false);
        panel66.add(toolBar1, BorderLayout.CENTER);
        ...
        panel66.add(m_languageComboBox, BorderLayout.EAST);
        ...
        label6.setLabelFor(m_returnPageIdTextField);
        label7.setLabelFor(m_moduleNameTextField);
        label8.setLabelFor(m_moduleConstraintTextField);
        label9.setLabelFor(m_autowireInConstraintTextField);
        label10.setLabelFor(m_autowireOutConstraintTextField);
    }
