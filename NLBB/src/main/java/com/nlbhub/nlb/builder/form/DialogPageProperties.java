...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        scrollPane10.setViewportView(m_returnPageIdTextField);
        final JLabel label5 = new JLabel();
        label5.setText("Return page Id");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.EAST;
        panel35.add(label5, gbc);
        ...
        scrollPane11.setViewportView(m_moduleNameTextField);
        final JLabel label6 = new JLabel();
        label6.setHorizontalTextPosition(11);
        label6.setText("Module name");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.anchor = GridBagConstraints.EAST;
        ...
        scrollPane12.setViewportView(m_moduleConstraintTextField);
        final JLabel label7 = new JLabel();
        label7.setText("Module constraint");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.EAST;
        ...
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        panel43.add(scrollPane13, gbc);
        m_autowireInConstraintTextField = new JTextField();
        m_autowireInConstraintTextField.setColumns(42);
        scrollPane13.setViewportView(m_autowireInConstraintTextField);
        final JLabel label8 = new JLabel();
        label8.setHorizontalTextPosition(11);
        label8.setText("Autowire in constraint");
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.anchor = GridBagConstraints.EAST;
        panel42.add(label8, gbc);
        ...
        panel48.setPreferredSize(new Dimension(505, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        ...
        panel1.add(panel49, BorderLayout.CENTER);
        ...
        panel53.setMinimumSize(new Dimension(10, 250));
        panel52.add(panel53, BorderLayout.CENTER);
        panel53.setBorder(BorderFactory.createTitledBorder("Page text"));
        ...
        scrollPane15.setViewportView(m_pageText);
        final JPanel panel54 = new JPanel();
        panel54.setLayout(new BorderLayout(0, 0));
        panel52.add(panel54, BorderLayout.EAST);
        ...
        label5.setLabelFor(m_returnPageIdTextField);
        label6.setLabelFor(m_moduleNameTextField);
        label7.setLabelFor(m_moduleConstraintTextField);
        label8.setLabelFor(m_autowireInConstraintTextField);
        label9.setLabelFor(m_autowireOutConstraintTextField);
    }
