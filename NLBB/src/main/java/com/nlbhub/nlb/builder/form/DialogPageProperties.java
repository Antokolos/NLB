...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        tabbedPane1.addTab("Module Traverse", panel30);
        ...
        tabbedPane1.addTab("Module Return", panel35);
        ...
        scrollPane8.setViewportView(m_returnPageIdTextField);
        ...
        gbc.gridy = 2;
        gbc.anchor = GridBagConstraints.WEST;
        panel36.add(m_autoReturnCheckBox, gbc);
        ...
        scrollPane9.setViewportView(m_returnTextTextField);
        ...
        panel1.add(panel39, BorderLayout.CENTER);
        ...
        panel43.setMinimumSize(new Dimension(10, 250));
        panel42.add(panel43, BorderLayout.CENTER);
        panel43.setBorder(BorderFactory.createTitledBorder("Page text"));
        ...
        panel1.add(panel44, BorderLayout.NORTH);
        final JToolBar toolBar1 = new JToolBar();
        toolBar1.setBorderPainted(false);
        toolBar1.setFloatable(false);
        panel44.add(toolBar1, BorderLayout.CENTER);
