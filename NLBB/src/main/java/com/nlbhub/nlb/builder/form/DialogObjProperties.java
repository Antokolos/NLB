...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel44.add(panel45, BorderLayout.NORTH);
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        panel52.add(m_effectMoveIn, gbc);
        final JPanel spacer7 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel52.add(spacer7, gbc);
        final JPanel spacer8 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 3;
        gbc.fill = GridBagConstraints.VERTICAL;
        panel52.add(spacer8, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 0;
        panel52.add(m_effectMoveOut, gbc);
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        panel52.add(m_effectFadeIn, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        panel52.add(m_effectFadeOut, gbc);
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        panel52.add(m_effectZoomIn, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 2;
        panel52.add(m_effectZoomOut, gbc);
