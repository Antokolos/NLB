...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel48.setMinimumSize(new Dimension(130, 180));
        panel48.setPreferredSize(new Dimension(130, 180));
        panel41.add(panel48);
        ...
        panel49.add(m_spinnerStartFrame, BorderLayout.WEST);
        final JPanel panel50 = new JPanel();
        panel50.setLayout(new BorderLayout(0, 0));
        panel50.setMinimumSize(new Dimension(95, 42));
        panel50.setPreferredSize(new Dimension(95, 42));
        panel48.add(panel50);
        final JLabel label14 = new JLabel();
        label14.setText("Max Frame");
        ...
        panel50.add(m_spinnerMaxFrame, BorderLayout.WEST);
        final JPanel panel51 = new JPanel();
        panel51.setLayout(new BorderLayout(0, 0));
        panel48.add(panel51);
        final JLabel label15 = new JLabel();
        label15.setText("Preload Frames");
        panel51.add(label15, BorderLayout.NORTH);
        ...
        panel51.add(m_spinnerPreloadFrames, BorderLayout.WEST);
        final JPanel panel52 = new JPanel();
        panel52.setLayout(new BorderLayout(0, 0));
        panel52.setMinimumSize(new Dimension(260, 150));
        panel52.setPreferredSize(new Dimension(260, 150));
        panel41.add(panel52);
        panel52.setBorder(BorderFactory.createTitledBorder("Movement direction"));
        ...
        panel57.add(m_movementDirectionRight);
        final JPanel panel58 = new JPanel();
        panel58.setLayout(new GridBagLayout());
        panel58.setMinimumSize(new Dimension(468, 33));
        panel58.setPreferredSize(new Dimension(468, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
