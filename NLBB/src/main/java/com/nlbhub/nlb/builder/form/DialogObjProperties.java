...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel41.setMinimumSize(new Dimension(380, 180));
        panel41.setPreferredSize(new Dimension(380, 180));
        panel40.add(panel41);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginLeftTop, gbc);
        final JPanel spacer5 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel43.add(spacer5, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginMiddleTop, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginLeftMiddle, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginMiddleMiddle, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginLeftBottom, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginMiddleBottom, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginRightBottom, gbc);
        ...
        gbc.weightx = 0.33;
        gbc.weighty = 0.33;
        panel43.add(m_coordsOriginRightMiddle, gbc);
        ...
        panel44.setMinimumSize(new Dimension(260, 180));
        panel44.setPreferredSize(new Dimension(260, 180));
        panel40.add(panel44);
        panel44.setBorder(BorderFactory.createTitledBorder("Effect"));
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        panel46.add(m_effectMoveIn, gbc);
        final JPanel spacer7 = new JPanel();
        gbc = new GridBagConstraints();
        gbc.gridx = 3;
        gbc.gridy = 0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        panel46.add(spacer7, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 0;
        panel46.add(m_effectMoveOut, gbc);
        ...
        gbc.gridx = 0;
        gbc.gridy = 1;
        panel46.add(m_effectFadeIn, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 1;
        panel46.add(m_effectFadeOut, gbc);
        ...
        gbc.gridx = 0;
        gbc.gridy = 2;
        panel46.add(m_effectZoomIn, gbc);
        ...
        gbc.gridx = 1;
        gbc.gridy = 2;
        panel46.add(m_effectZoomOut, gbc);
        ...
        gbc.gridx = 2;
        gbc.gridy = 1;
        panel46.add(m_effectOverlap, gbc);
        final JPanel panel47 = new JPanel();
        panel47.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 5));
        panel47.setMinimumSize(new Dimension(130, 180));
        panel47.setPreferredSize(new Dimension(130, 180));
        panel40.add(panel47);
        panel47.setBorder(BorderFactory.createTitledBorder("Frames"));
        final JPanel panel48 = new JPanel();
        panel48.setLayout(new BorderLayout(0, 0));
        panel48.setMinimumSize(new Dimension(95, 42));
        panel48.setPreferredSize(new Dimension(95, 42));
        panel47.add(panel48);
        final JLabel label12 = new JLabel();
        label12.setText("Start Frame");
        panel48.add(label12, BorderLayout.NORTH);
        m_spinnerStartFrame = new JSpinner();
        m_spinnerStartFrame.setMinimumSize(new Dimension(90, 26));
        m_spinnerStartFrame.setPreferredSize(new Dimension(90, 26));
        panel48.add(m_spinnerStartFrame, BorderLayout.WEST);
        final JPanel panel49 = new JPanel();
        panel49.setLayout(new BorderLayout(0, 0));
        panel49.setMinimumSize(new Dimension(95, 42));
        panel49.setPreferredSize(new Dimension(95, 42));
        panel47.add(panel49);
        final JLabel label13 = new JLabel();
        label13.setText("Max Frame");
        panel49.add(label13, BorderLayout.NORTH);
        ...
        panel49.add(m_spinnerMaxFrame, BorderLayout.WEST);
        final JPanel panel50 = new JPanel();
        panel50.setLayout(new BorderLayout(0, 0));
        panel47.add(panel50);
        final JLabel label14 = new JLabel();
        label14.setText("Preload Frames");
        panel50.add(label14, BorderLayout.NORTH);
        ...
        panel50.add(m_spinnerPreloadFrames, BorderLayout.WEST);
        final JPanel panel51 = new JPanel();
        panel51.setLayout(new BorderLayout(0, 0));
        panel51.setMinimumSize(new Dimension(260, 150));
        panel51.setPreferredSize(new Dimension(260, 150));
        panel40.add(panel51);
        panel51.setBorder(BorderFactory.createTitledBorder("Movement direction"));
        final JPanel panel52 = new JPanel();
        panel52.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        panel51.add(panel52, BorderLayout.NORTH);
        ...
        panel56.add(m_movementDirectionRight);
        final JPanel panel57 = new JPanel();
        panel57.setLayout(new GridBagLayout());
        panel57.setMinimumSize(new Dimension(468, 33));
        panel57.setPreferredSize(new Dimension(468, 33));
        gbc = new GridBagConstraints();
        gbc.gridx = 1;
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        ...
        label12.setLabelFor(m_spinnerStartFrame);
        label13.setLabelFor(m_spinnerMaxFrame);
        label14.setLabelFor(m_spinnerPreloadFrames);
        label15.setLabelFor(m_offset);
