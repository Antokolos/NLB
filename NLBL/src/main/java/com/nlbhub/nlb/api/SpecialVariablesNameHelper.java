/**
 * @(#)SpecialVariablesNameHelper.java
 *
 ...
 * @author Antokolos
 */
public class SpecialVariablesNameHelper {

    public static String decorateId(String id) {
        return id.replaceAll("-", "_");
    }
    public static String decorateLinkVisitStateVar(String linkId) {
        return "lvs_" + linkId.replaceAll("-", "_");
    }
