...
public class NonLinearBookFacade implements NLBObservable {
    ...
    private void exportAdditionalMedia(File exportDir) throws NLBIOException {
        ...
        if (sfxDir.mkdir()) {
            exportBundledVNSTEADFile(sfxDir, true, "dice_roll.ogg");
            exportBundledVNSTEADFile(sfxDir, true, "kosti.ogg");
            exportBundledVNSTEADFile(sfxDir, true, "money.ogg");
            exportBundledVNSTEADFile(sfxDir, true, "shake.ogg");
        }
        ...
        if (gfxDir.mkdir()) {
            ...
            exportBundledVNSTEADFile(gfxDir, true, "menubtn_ru.png");
            exportBundledVNSTEADFile(gfxDir, true, "adown.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_dice.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_dice2.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_exit.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_exit2.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_inc.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_inc2.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_next.png");
            exportBundledVNSTEADFile(gfxDir, true, "alt_btn_next2.png");
            exportBundledVNSTEADFile(gfxDir, true, "aup.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_dice.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_dice2.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_exit.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_exit2.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_inc.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_inc2.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_next.png");
            exportBundledVNSTEADFile(gfxDir, true, "btn_next2.png");
            exportBundledVNSTEADFile(gfxDir, true, "dice.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.1.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "e.2.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "empty.png");
            exportBundledVNSTEADFile(gfxDir, true, "fl.png");
            exportBundledVNSTEADFile(gfxDir, true, "fr.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.1.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "n.2.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "paper1.png");
            exportBundledVNSTEADFile(gfxDir, true, "paper2.png");
            exportBundledVNSTEADFile(gfxDir, true, "plate.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0000-0038.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0039-0050.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0051-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0101-0150.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0151-0200.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.0201-0270.png");
            exportBundledVNSTEADFile(gfxDir, true, "reward.meta");
            exportBundledVNSTEADFile(gfxDir, true, "round_finished.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.1.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "s.2.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "table1.png");
            exportBundledVNSTEADFile(gfxDir, true, "table2.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die6.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.1.die6.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die1.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die1.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die2.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die2.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die3.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die3.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die4.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die4.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die5.0000-0100.png");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die5.meta");
            exportBundledVNSTEADFile(gfxDir, true, "w.2.die6.0000-0100.png");
    ...
    public void updateBookProperties(
        ...
        NonLinearBookImpl.UpdateBookPropertiesCommand command = (
                m_nlb.createUpdateBookPropertiesCommand(license, language, title, author, version, perfectGameAchievementName, fullAutowire, suppressMedia, suppressSound, propagateToSubmodules)
        );
