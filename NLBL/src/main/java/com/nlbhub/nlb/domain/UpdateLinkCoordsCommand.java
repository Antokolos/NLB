...
/**
 * The UpdateLinkCoordsCommand class
 *
 * @author Anton P. Kolosov
 * @version 1.0 1/17/14
 */
public class UpdateLinkCoordsCommand implements NLBCommand {
    ...
    private UpdateLinkCoordsCommand(NonLinearBookImpl nonLinearBook, Link link) {
        ...
        m_linkImpl = nodeItem.getLinkById(link.getId());
        final CoordsImpl coords = m_linkImpl.getCoords();
